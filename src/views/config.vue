...
const rules = reactive({
     ...
     */
    // MySQL数据库地址
    hostname: [{ required: true, message: '请输入MySQL数据库地址', trigger: 'blur' }],
    // MySQL数据库用户名
    username: [{ required: true, message: '请输入MySQL数据库用户名', trigger: 'blur' }],
    // MySQL数据库密码
    password: [{ required: true, message: '请输入MySQL数据库密码', trigger: 'blur' }],
    // MySQL数据库端口
    hostport: [{ required: true, message: '请输入MySQL数据库端口', trigger: 'blur' }],
    // MySQL数据库名称
    database: [{ required: true, message: '请输入MySQL数据库名称', trigger: 'blur' }],
    // MySQL数据库表前缀
    prefix: [{ required: true, message: '请输入MySQL数据库表前缀', trigger: 'blur' }],
    /**
     * 二：管理员部分
     */
    // 管理员用户名
    ...
    // 重复管理员密码
    repeatadminpassword: [{ required: true, message: '请重复管理员密码', trigger: 'blur' }],
    /**
     * 三：站点部分
     */
    // 站点名称
